...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    about = models.TextField(null=True, blank=True, db_collation='utf8mb4_unicode_ci', help_text="내 소개")
    ...
    github_url = models.CharField(max_length=255, default="", help_text="github url")
    blog_url = models.CharField(max_length=255, default="", help_text="blog url")
